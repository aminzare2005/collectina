...
const TOAST_ROOT_BASE = cn(
  ...
  "data-[position*=center]:left-4 data-[position*=center]:right-4 data-[position*=center]:w-auto",
...
function ToastBody({
  ...
  return (
    <ToastPrimitive.Content
      data-slot="toast-content"
      className="pointer-events-auto flex items-start gap-2.5 overflow-hidden px-3 py-2.5 text-sm transition-opacity duration-250 data-behind:opacity-0 data-expanded:opacity-100"
    >
      {Icon && (
        <span
  ...
  return (
    <ToastPrimitive.Portal data-slot="toast-portal" {...portalProps}>
      <ToastPrimitive.Viewport
        ...
        className={cn(
          "pointer-events-none fixed z-99999 mx-auto flex w-full max-w-sm [--toast-inset:5.5rem] sm:[--toast-inset:6rem]",
